...
3. **添加变量**
   ...
   Value: https://poly-u--kinson092253.replit.app/api
   ```
...
- API 请求是否发送到 `https://poly-u--kinson092253.replit.app/api`
...
API_BASE_URL = 'https://poly-u--kinson092253.replit.app/api'  // 使用环境变量
```
...
A: 创建 `.env.local` 文件：
```
REACT_APP_API_URL=https://poly-u--kinson092253.replit.app/api
```
